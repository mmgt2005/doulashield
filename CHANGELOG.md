...
- **CMS 1500 Box 24F and Box 28 charge amounts included decimal**: the form has a pre-printed decimal separator in the charge field; entering "100.00" misaligns the value; changed to integer dollars ("100", "1000") with no decimal
